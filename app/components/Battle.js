  ...
  render() {
    ...
    return (
      <form className="column" onSubmit={this.handleSubmit}>
        ...
        <input type="text" id="username" placeholder='github username' autoComplete='off' value={username} onChange={this.handleChange} />
        <button type='submit' className="button" disabled={!username}>Submit</button>
      </form>
    )
  }
}
